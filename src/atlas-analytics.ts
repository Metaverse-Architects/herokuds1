...
// const branchName: string = "Default Branch"; // use a unique name to differentiate different deployments or instances
// const pollingInterval: number = 5000; // miliseconds
